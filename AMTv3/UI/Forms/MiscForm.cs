...
namespace ArdysaModsTools
{
    public partial class MiscForm : Form
    {
        ...
        static MiscForm()
        {
            ...
            // string githubToken = "[ghp] _ [5TTdtvfPVNA2g8kiAs292FcPa82IN4107pbg]";
        ...
        private async Task PerformGeneration()
        {
            try
            {
                ...
                using (Process packProcess = new Process { StartInfo = packPsi })
                {
                    ...
                    if (!string.IsNullOrEmpty(packOutput)) SafeLog($"Decompile output...");
                    if (!string.IsNullOrEmpty(packError)) SafeLog($"Decompile error!");
                    ...
                    if (packProcess.ExitCode == 0)
                    {
                        ...
                        if (File.Exists(tempVpk))
                        {
                            ...
                            // Clean up _temp folder except for extraction.log
                            ...
                            if (Directory.Exists(tempDir))
                            {
                                ...
                                // Ensure _temp remains visible for debugging
