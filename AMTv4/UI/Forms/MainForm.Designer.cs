namespace ArdysaModsTools
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            mainConsoleBox = new RichTextBox();
            label1 = new Label();
            ...
            // mainConsoleBox
            // 
            mainConsoleBox.BackColor = Color.FromArgb(40, 40, 40);
            mainConsoleBox.BorderStyle = BorderStyle.FixedSingle;
            mainConsoleBox.DetectUrls = false;
            mainConsoleBox.Font = new Font("Cascadia Code", 9F, FontStyle.Regular, GraphicsUnit.Point, 0);
            mainConsoleBox.ForeColor = Color.FromArgb(200, 200, 200);
            mainConsoleBox.Location = new Point(13, 343);
            mainConsoleBox.Margin = new Padding(4, 3, 4, 3);
            mainConsoleBox.Name = "mainConsoleBox";
            mainConsoleBox.ReadOnly = true;
            mainConsoleBox.ScrollBars = RichTextBoxScrollBars.Vertical;
            mainConsoleBox.Size = new Size(326, 124);
            mainConsoleBox.TabIndex = 13;
            mainConsoleBox.Text = "";
            mainConsoleBox.TextChanged += mainConsoleBox_TextChanged;
            // 
            // label1
            // 
            ...
            versionLabel.ForeColor = Color.MintCream;
            versionLabel.Location = new Point(248, 481);
        ...
        private System.Windows.Forms.RichTextBox mainConsoleBox;
